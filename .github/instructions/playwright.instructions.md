...
- **Clarity**: Use descriptive test and step titles that clearly state the intent. Add comments only to explain complex logic or non-obvious interactions; never restate the locator or assertion.
...
- [ ] Comments explain intent or non-obvious interactions and are current
