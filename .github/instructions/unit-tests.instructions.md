...
- Comment only the intent behind non-obvious setup or assertions; do not narrate straightforward test steps.
- Keep test comments current when the fixture or behavior changes.
